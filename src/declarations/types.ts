...
export enum ERRORS {
    TYPE = "TYPE",
    REQUIRED = "REQUIRED",
    ARR_WRONG_TYPE = "MUST_BE_ARRAY_OR_STRING",
    ...
    ALLOWED_VALUES_NOT_SET = "ALLOWED_VALUES_NOT_SET",
    ALLOWED_VALUES_NOT_ARR = "ALLOWED_VALUES_IS_NOT_ARRAY",
    ALLOWED_PROPS_NOT_SET = "ALLOWED_PROPS_NOT_SET",
    ALLOWED_PROPS_NOT_ARR = "ALLOWED_PROPS_IS_NOT_ARRAY",
